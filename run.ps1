...
#cmd /C 'dotnet TwitterTracker\bin\Debug\netcoreapp2.1\TwitterTracker.dll -tx news | dotnet TwitterTracker.Filter\bin\Debug\netcoreapp2.1\TwitterTracker.Filter.dll "$.root[?(@.user.followers_count>400)]" "$.root[?(@.lang==''en'')]" | dotnet TwitterTracker.Extract.Urls\bin\Debug\netcoreapp2.1\TwitterTracker.Extract.Urls.dll | dotnet TwitterTracker.Utilities.Frequency\bin\Debug\netcoreapp2.1\TwitterTracker.Utilities.Frequency.dll -console'

#This is an example of how to run the telegram bot for distribution of information
#cmd /C 'dotnet TwitterTracker\bin\Debug\netcoreapp2.1\TwitterTracker.dll -tx "news" | dotnet TwitterTracker.Filter\bin\Debug\netcoreapp2.1\TwitterTracker.Filter.dll "$.root[?(@.user.followers_count>250)]" "$.root[?(@.lang==''en'')]" | dotnet TwitterTracker.Extract.Urls\bin\Debug\netcoreapp2.1\TwitterTracker.Extract.Urls.dll | dotnet TelegramBot\bin\Debug\netcoreapp3.1\TelegramBot.dll'